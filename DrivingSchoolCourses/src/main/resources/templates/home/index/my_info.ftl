    ...
    <div class="layui-row">
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            <ul class="layui-tab-title">
                ...
                <li  <#if tabIndex == 2>class="layui-this" </#if>>订单管理</li>
            </ul>
                            ...
                            <#if appointMentList.content??>
                                 <#list appointMentList.content as appointment>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="button" class="layui-btn-sm
                                             <#if appointment.isRate == 1>layui-disabled<#else>layui-btn</#if>" value="评分"
                                                   <#if appointment.isRate == 1>disabled</#if>
                                            onclick="M.rate(${appointment.courses.id}, '${appointment.courses.title}',${appointment.id})"/>
                                        </td>
                                        <td>
...
<div class='simple_dlg_define' style='display:none'>
    <div class='pane' style='padding:16px'>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input layui-disabled course-title" disabled value=""/>
            </div>
        </div>
