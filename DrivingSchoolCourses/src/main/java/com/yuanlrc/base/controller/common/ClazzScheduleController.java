...
import com.yuanlrc.base.entity.home.ClazzSchedule;
...
public class ClazzScheduleController {
    ...
    public Result<Boolean> add(ClazzSchedule clazzSchedule,
       ...
       /* SimpleDateFormat sft = new SimpleDateFormat("yyyy-MM-dd");
        String startDatea = sft.format(clazzSchedule.getStartDate());
        String endDates = sft.format(clazzSchedule.getEndDate());
        //排斥冲突检测
        ClazzSchedule scheduleCount = scheduleService.getScheduleCount(clazzSchedule.getCourses().getId(), startDatea, endDates);
        if (scheduleCount != null) {
            return Result.error(CodeMsg.ADMIN_SCHEDULE_DATE_PAI_ERROR);
        }*/
