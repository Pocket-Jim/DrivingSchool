...
public class CodeMsg {
	...
	public static CodeMsg HOME_APPOINTMENT_DELETE_ERROR2 = new CodeMsg(-50001, "你不能取消已经开始或已经结束的课程预约");
	...
	public static CodeMsg ADMIN_NEWSTITLE_EXIST = new CodeMsg(-21001, "该新闻标题已存在，请换一个试试！");
	...
	public static CodeMsg ADMIN_SCHEDULE_DATE_PAI_ERROR=new CodeMsg(-24005,"已经有课程安排请更换日期");
